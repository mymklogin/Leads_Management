...
const THEMES = {
  ...
  afternoon: {
    ...
    iconShadow: '0 6px 18px rgba(2, 132, 199, 0.4)',
    leftCardBg: 'linear-gradient(150deg, #075985 0%, #0284c7 40%, #1d4ed8 100%)',
    buttonBg: 'linear-gradient(135deg, #0284c7 0%, #0369a1 100%)',
    buttonHoverBg: 'linear-gradient(135deg, #0369a1 0%, #075985 100%)',
    buttonShadow: '0 6px 20px rgba(2, 132, 199, 0.4)',
    accentColor: '#0284c7',
    skyBg: 'linear-gradient(180deg, #0284c7 0%, #0ea5e9 28%, #38bdf8 62%, #60a5fa 88%, #93c5fd 100%)',
    sunGradient: 'radial-gradient(circle at 35% 35%, #ffffff 0%, #fef08a 35%, #fbbf24 75%, #f59e0b 100%)',
    sunGlow: '0 0 75px 32px rgba(253, 224, 71, 0.65), 0 0 150px 75px rgba(245, 158, 11, 0.35)',
